  ...
  create  table "financial_data"."financial_clean"."dim_organization_overview__dbt_tmp"
  ...
  (
    ...
    select * from "financial_data"."financial_raw"."stg_organization"
),

overview as (
    select * from "financial_data"."financial_raw"."stg_organization_overview"
),
